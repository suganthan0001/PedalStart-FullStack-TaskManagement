...
function Login() {
  return (
    <div className='h-screen w-full flex justify-center items-center text-center'>
      ...
      <div className='shadow-2xl border-black rounded-md p-5 flex flex-col justify-between gap-5 py-10'>
        <h1 class="mb-4 text-2xl text-gray-900 md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Task Management</span> App</h1>

        <div class="px-6 sm:px-0 max-w-sm mx-auto">
